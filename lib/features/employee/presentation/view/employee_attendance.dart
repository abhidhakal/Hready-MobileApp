      ...
      onProximityDetected: () {
        if (mounted) {
          ...
          if (!_hasShownInitialSnackbar) {
            ...
            if (state is AttendanceLoaded && state.todayStatus != 'Checked Out') {
    ...
    if (state is AttendanceLoaded) {
      ...
      if (todayStatus == 'Not Checked In' || todayStatus == 'Checked Out') {
        ...
        Future.delayed(const Duration(seconds: 2), () {
          attendanceBloc.add(LoadTodayAttendance());
        });
      ...
      print('State is not AttendanceLoaded: ${state.runtimeType}'); // Debug log
