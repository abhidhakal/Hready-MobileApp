...
class AdminLocalRepository implements IAdminRepository{
  final AdminLocalDatasource _adminLocalDatasource;

  AdminLocalRepository({required AdminLocalDatasource adminLocalDatasource}) : _adminLocalDatasource = adminLocalDatasource;
